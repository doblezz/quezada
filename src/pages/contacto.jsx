        ...
        <div className={styles.contacto}>
          ...
          <div className={styles.callcenter}>
            <section className={styles.section}>
              ...
              <p className="details"><a href="#2">(809) 556-2702</a></p>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p><a href="#2">(809) 556-5111</a></p>
            </section>

            <section className={styles.section}>
              <h4>Tel – Oficinas Bávaro y Punta Cana:</h4>
              <p><a href="#2">(809) 552-1517</a></p>
            </section>
          </div>
          ...
          <div className={styles.email}>
            ...
            <section className={styles.section}>
              <p>
                <h5>Empresa</h5>
                <li><a href="#2">quezadaonline@agentedecambioquezada.com</a></li>
              </p>
              <p>
                <h5>Mesa de divisas:</h5>
                <li><a href="#2">divisas@agentedecambioquezada.com</a></li>
              </p>
              <p>
                <h5>Contabilidad:</h5>
                <li><a href="#2">Contabilidad@agentedecambioquezada.com</a></li>
              </p>
              <p>
                <h5>Recursos Humanos:</h5>
                <li><a href="#2">rrhh@agentedecambioquezada.com</a></li>
              </p>
              <p>
                <h5>Cumplimiento:</h5>
                <li><a href="#2">Cumplimiento@agentedecambioquezada.com</a></li>
              </p>
            </section>
          </div>
        </div>
